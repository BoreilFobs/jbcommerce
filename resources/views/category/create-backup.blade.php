...
<div class="main-content p-4 sm:p-6 max-w-3xl mx-auto">
    <div class="card bg-white rounded-lg shadow-sm p-4 sm:p-6">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 border-b border-gray-200 pb-4 gap-4">
            <h4 class="text-xl font-bold text-gray-800">Nouvelle Catégorie</h4>
        ...
        <form action="{{ url('/categories/create') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div id="image-preview-container" class="mt-4 hidden">
                ...
                <div class="relative w-full max-w-sm mx-auto">
                    <img id="image-preview" src="#" alt="Aperçu" class="w-full aspect-video object-cover rounded-lg border border-gray-300 shadow-sm">
                    <button type="button" id="remove-image" class="absolute top-2 right-2 bg-red-500 text-white rounded-full p-2 hover:bg-red-600 transition-colors">
