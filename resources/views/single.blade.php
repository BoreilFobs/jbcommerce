                        ...
                        <div class="col-12 col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="row g-4 single-product">
                                ...
                                <div class="col-xl-6">
                                    ...
                                    <h5 class="fw-bold mb-3">{{number_format($offer->price, 0, '.', ',')}}FCFA</h5>
                                    ...
                                    <div class="d-flex flex-column mb-3">
                                        ...
                                        <small>Disponible: <strong class="text-primary">{{$offer->quantity}} en stock</strong></small>
                                    </div>
                                    ...
                                    @if(Auth::check())
                                        <a href="{{ route('cart.add', $offer->id) }}" class="btn btn-primary border border-secondary rounded-pill px-4 py-2 mb-4 text-primary"><i class="fa fa-shopping-bag me-2 text-white"></i> Ajouter au panier</a>
                                    @else
